...
has_vcf = "ReferenceAlleleVCF" in cols
print("ReferenceAlleleVCF column present:", has_vcf)
...
bl_rsids = {f"rs{r[0]}" for r in conn.execute(
    'SELECT "RS# (dbSNP)" FROM blocklist')}
